...
use crate::test::observer_fixtures::{RecordingObserver, as_attempt_skipped, event_names};
use agent_core::{ProviderInstanceId, ProviderKind, types::Message};

use crate::{
    ExecutionOptions, RuntimeErrorKind,
    test::{
