use agent_core::{
    CanonicalStreamEnvelope, CanonicalStreamEvent, ProviderInstanceId, ProviderKind, ResponseMode,
};
use futures_util::StreamExt;

use crate::agent_toolkit::AgentToolkit;
use crate::message::{MessageCreateInput, MessageTextStream};
use crate::provider::ProviderConfig;
use crate::routing::{Route, Target};

use crate::test::executed_failure_meta;
use crate::test::stream_test_fixtures::spawn_sse_stub;
use crate::test::streaming_test_fixtures::test_streaming_provider_client;
