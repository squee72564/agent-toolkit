...
use crate::protocols::anthropic_spec::AnthropicDecodeEnvelope;
use crate::protocols::error::{AdapterError, AdapterErrorKind, AdapterProtocol};
use crate::protocols::openai_spec::OpenAiDecodeEnvelope;
use crate::protocols::platform::anthropic::translator::AnthropicTranslator;
use crate::protocols::platform::openai::translator::OpenAiTranslator;
use crate::protocols::platform::openrouter::translator::OpenRouterTranslator;
use crate::protocols::translator_contract::ProtocolTranslator;
use crate::transport::{HttpJsonResponse, HttpTransport, RetryPolicy, TransportError};
...
fn prepend_encode_warnings(
    ...
    mut encode_warnings: Vec<crate::RuntimeWarning>,
) {
